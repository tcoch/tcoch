...
- :heavy_check_mark: [[symfony/symfony-docs]](https://github.com/symfony/symfony-docs/pull/21865) - [DependencyInjection][Secrets] Add a section to give the best pratices for accessing secrets in a service
